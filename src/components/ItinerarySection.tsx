...
const events: EventDay[] = [
  {
    ...
    abhishekEvents: [
      ...
      { time: '14:30 - 17:00', event: 'Haldi' },
      { time: '18:30', event: 'Engagement and Sangeet' },
    ],
    nidhiEvents: [
      { time: '07:00 - 08:30', event: 'Sapna & Ganpati Sthapana' },
      { time: '09:00 - 10:00', event: 'Breakfast' },
      { time: '10:30 - 11:00', event: 'Kalash' },
      { time: '12:00', event: 'Lunch' },
      { time: '14:30 - 17:00', event: 'Haldi' },
      { time: '18:30', event: 'Engagement and Sangeet' },
    ]
  },
  {
    ...
    abhishekEvents: [
      ...
      { time: '20:00', event: 'Cheka, Tilak + Varmala ' },
      { time: '22:00', event: "Gehana Chadhai" },
      { time: '23:00', event: 'Shubh Vivah' },
      { time: '04:00', event: 'Vidai' },
    ],
    nidhiEvents: [
      { time: '07:00 - 08:00', event: 'Sapna' },
      { time: '08:00', event: 'Breakfast' },
      { time: '10:30', event: " Mayra" },
      { time: '12:00', event: 'Lunch' },
      { time: '17:00', event: 'Barat Timing' },
      { time: '18:00', event: 'Toran/Dwar Puja' },
      { time: '20:00', event: 'Cheka, Tilak + Varmala' },
